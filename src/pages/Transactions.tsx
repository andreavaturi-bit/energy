...
function TransactionModal({
  ...
  return (
    <FormModal
      title={isEdit ? 'Modifica Transazione' : prefill ? 'Duplica Transazione' : 'Nuova Transazione'}
      size="lg"
      onClose={onClose}
      onSubmit={handleSave}
      submitDisabled={!canSave}
      isSubmitting={!!isSaving}
      submitLabel={isEdit ? 'Salva Modifiche' : (isTransfer ? 'Salva Trasferimento' : 'Salva Transazione')}
    >
      {/* Row: Date + Type */}
