...
VALUES (gen_random_uuid(), 'Personale', 'scope', '#3B82F6', 'user');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Familiare', 'scope', '#8B5CF6', 'users');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Aziendale Kairos', 'scope', '#F59E0B', 'building');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'VS / Opzionetika', 'scope', '#EF4444', 'target');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Ghiaccio Spettacolo', 'scope', '#06B6D4', 'snowflake');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Ace of Diamonds', 'scope', '#DC2626', 'diamond');

-- --- PURPOSE (finalita) - 5 records ---

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Da dividere con Mirko', 'purpose', '#F97316', 'split');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Versamento c/capitale', 'purpose', '#14B8A6', 'arrow-down-to-line');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Scaricabile IVA', 'purpose', '#84CC16', 'receipt');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Per conto parenti', 'purpose', '#D946EF', 'heart-handshake');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Accantonamento figli', 'purpose', '#EC4899', 'baby');

-- --- CATEGORY - Spese personali/familiari - 21 records ---

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Affitto', 'category', '#6366F1', 'home');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Box', 'category', '#6366F1', 'car');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Bollette', 'category', '#F59E0B', 'zap');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Acqua', 'category', '#06B6D4', 'droplets');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Spesa alimentare', 'category', '#22C55E', 'shopping-cart');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Scuola', 'category', '#8B5CF6', 'book-open');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Milano Ristorazione', 'category', '#F97316', 'utensils');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Baby Sitter', 'category', '#EC4899', 'baby');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Pulizie casa', 'category', '#14B8A6', 'sparkles');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Automobile', 'category', '#64748B', 'car');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Telepass', 'category', '#3B82F6', 'toll');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Assicurazioni', 'category', '#DC2626', 'shield');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Assicurazioni familiari', 'category', '#DC2626', 'shield-check');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Carta di credito', 'category', '#C5A44E', 'credit-card');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Vacanze e viaggi', 'category', '#0EA5E9', 'plane');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Regali', 'category', '#F43F5E', 'gift');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Palestra', 'category', '#22C55E', 'dumbbell');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Capelli', 'category', '#A855F7', 'scissors');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Beneficenza', 'category', '#F472B6', 'heart');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Comunita'' ebraica', 'category', '#2563EB', 'star');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Attivita'' familiari e sportive', 'category', '#10B981', 'trophy');

-- --- CATEGORY - Tasse e imposte - 5 records ---

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'TARI', 'category', '#EF4444', 'file-text');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'F24 - IVA', 'category', '#DC2626', 'file-text');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'F24 - IRPEF', 'category', '#DC2626', 'file-text');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'F24 - Cedolini', 'category', '#DC2626', 'file-text');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Multe', 'category', '#EF4444', 'alert-triangle');

-- --- CATEGORY - Subscriptions / Strumenti - 13 records ---

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Netflix', 'category', '#E50914', 'tv');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Disney+', 'category', '#113CCF', 'tv');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Amazon Prime', 'category', '#FF9900', 'tv');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'YouTube', 'category', '#FF0000', 'tv');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Spotify', 'category', '#1DB954', 'music');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Notion', 'category', '#000000', 'layout');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'ChatGPT', 'category', '#10A37F', 'bot');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Claude', 'category', '#D4A574', 'bot');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Google Premium', 'category', '#4285F4', 'search');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'TradingView', 'category', '#2962FF', 'bar-chart');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'VPN/VPS', 'category', '#6366F1', 'shield');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Domini', 'category', '#64748B', 'globe');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Software e abbonamenti', 'category', '#8B5CF6', 'package');

-- --- CATEGORY - Business - 8 records ---

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Commercialista personale', 'category', '#475569', 'calculator');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Commercialista aziendale', 'category', '#475569', 'calculator');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Assicurazioni professionali', 'category', '#DC2626', 'shield');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Collaboratori', 'category', '#F97316', 'users');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Ufficio', 'category', '#64748B', 'building-2');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'PEC', 'category', '#3B82F6', 'mail');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Fatturazione elettronica', 'category', '#14B8A6', 'file-check');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Whoop', 'category', '#000000', 'watch');

-- --- CATEGORY - Entrate - 6 records ---

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Coreografia', 'category', '#22C55E', 'music-2');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Insegnamento', 'category', '#22C55E', 'graduation-cap');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Formazione / Speaker', 'category', '#22C55E', 'mic');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Consulenza', 'category', '#22C55E', 'briefcase');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Corsi VS / Opzionetika', 'category', '#22C55E', 'presentation');

INSERT INTO "tags" ("id", "name", "type", "color", "icon")
VALUES (gen_random_uuid(), 'Earnings (trading)', 'category', '#22C55E', 'trending-up');
